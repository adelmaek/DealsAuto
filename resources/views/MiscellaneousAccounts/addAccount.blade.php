            ...
            white-space: nowrap;">
                <div class="table-responsive-sm">
                    <table class="table color-bordered-table table-striped full-color-table full-dark-table hover-table ">
                        ...
                        <tbody>
                            <tr>
                                <form id="transaction-form" class="form"action="{{route('miscelAccount')}}" method="post">
                                    <td style="text-align:center">
                                        <input type="text" class="form-control" id="nameInput" name="nameInput" placeholder="اسم الحساب" required style="min-width: 100px;text-align: center;" >
                                    </td>
                                    <td style="text-align:center">
    ...
    <div class="col">
        <div class="card border-dark">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">ِAccounts</h4>
            </div>
            <div class="card-body" style="width: auto;white-space: nowrap;">
                <div class="table-responsive-sm">
                    <table id="MiscelAccountsTable" class="table color-bordered-table table-striped full-color-table full-info-table hover-table" data-display-length='-1' data-order="[]" >
                        <thead>
                            <tr>
                                <th scope="col" class="text-center" >اسم الحساب</th>
                                <th scope="col" class="text-center" >قيمة التعاملات الحالية</th>
                        ...
                        <tbody>
                            @foreach ($accounts as $account)
                                <tr>
                                    ...
                                    <td class="text-center">{{$account->currentBalance}}</td>
                                    <td style="text-align:center">
                                        <a class="btn btn-danger delete-confirm" style="height:25px;padding: 3px 8px;padding-bottom: 3px;" href="{{route('delMiscelAccount',['account_id'=>$account->id])}}" role="button">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
