    ...
    <div class="col-md">
        ...
        <div class="card border-dark">
            <div class="card-header bg-dark">
                <h4 class="m-b-0 text-white">Add Sales Transactions</h4>
            </div>
            ...
            white-space: nowrap;">
                <div class="table-responsive-sm">
                    <table class="table color-bordered-table table-striped full-color-table full-dark-table hover-table ">
                        ...
                        <tbody>
                            <tr>
                                <form id="transaction-form" class="form"action="{{route('salesTrans')}}" method="post">
    ...
    <div class="col">
        <div class="card border-dark">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">Sales Transactions</h4>
            </div>
            <div class="card-body" style="width: auto;white-space: nowrap;">
                <div class="table-responsive-sm">
                    <table id="salesTable" class="table color-bordered-table table-striped full-color-table full-info-table hover-table" data-display-length='-1' data-order="[]" >
                        <thead>
                            <tr>
                                <th scope="col" class="text-center" >العملية</th>
                                <th scope="col" class="text-center" >التاريخ</th>
                        ...
                        <tbody>
                            @foreach ($salesTransactions as $trans)
                                <tr>
